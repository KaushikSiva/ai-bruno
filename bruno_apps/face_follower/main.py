...
Usage:
  python3 face_follow_test.py --mode external --audio --voice Dominoux
...
def main():
    ...
    parser.add_argument('--mode', choices=['builtin', 'external'], 
                       default=get_env_str('CAM_MODE'),
                       help='Camera mode (default: external)')
    parser.add_argument('--audio', action='store_true', 
                       help='Enable audio greetings')
    parser.add_argument('--voice', default=get_env_str('BRUNO_AUDIO_VOICE'),
                       help='TTS voice (default: Dominoux)')
